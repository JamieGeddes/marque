...
export const halls: HallDefinition[] = [
  ...
  },
  {
    ...
    carIds: ['mazda-787b', 'audi-r15-tdi', 'audi-r18', 'toyota-ts030', 'peugeot-9x8', 'porsche-963'],
  },
  {
    id: 'molsheim-vault',
    ordinal: '14',
    title: 'The Molsheim Vault',
    tagline: 'Ettore’s heirs, from the Veyron to the V16',
    carIds: [
      'bugatti-veyron',
      'bugatti-chiron',
      'bugatti-divo',
  ...
  },
  {
    id: 'angelholm',
    ordinal: '15',
    title: 'Ängelholm Megacars',
    tagline: 'A small Swedish workshop chasing the absolute',
    carIds: ['koenigsegg-ccx', 'koenigsegg-one', 'koenigsegg-agera-rs', 'koenigsegg-jesko'],
  },
  {
    id: 'trident',
    ordinal: '16',
    title: 'Sign of the Trident',
    tagline: 'Modena’s other marque, from MC12 to MC20',
    carIds: ['maserati-mc12', 'maserati-mc20'],
  },
  {
    id: 'rally-stradale',
    ordinal: '17',
    title: 'Rally Stradale',
    tagline: 'Turin’s homologation specials, bred on gravel',
    carIds: ['lancia-stratos', 'lancia-037', 'lancia-delta-integrale'],
  },
  {
    id: 'best-of-british',
    ordinal: '18',
    title: 'Best of British',
    tagline: 'Island speed, from Coventry to Blackpool',
    carIds: [
      'jaguar-xj220',
      'jaguar-xkr',
      'noble-m600',
  ...
  },
  {
    id: 'peoples-cars',
    ordinal: '19',
    title: 'The People’s Cars',
    tagline: 'Wolfsburg’s gifts to the many',
    carIds: ['vw-beetle', 'vw-golf-gti-mk1'],
  },
  {
    id: 'made-in-woking',
    ordinal: '20',
    title: 'Made in Woking',
    tagline: 'McLaren, from the F1 to the W1',
    carIds: [
      'mclaren-f1',
      'mclaren-f1-lm',
      'mclaren-mp4-12c',
  ...
  },
  {
    ...
    ordinal: '21',
    title: 'Small Wonders',
    tagline: 'Issigonis’ giant-killer, then and now',
    carIds: ['mini-cooper-s-classic', 'mini-jcw-gp', 'mini-jcw-cabrio'],
  },
  {
    id: 'atelier-hypercars',
    ordinal: '22',
    title: 'Atelier Hypercars',
    tagline: 'Low-volume makers chasing the absolute',
    carIds: ['pagani-zonda-f', 'rimac-nevera-r', 'glickenhaus-scg-004c'],
  },
]
